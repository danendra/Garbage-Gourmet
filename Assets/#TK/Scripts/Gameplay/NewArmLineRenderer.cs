...
namespace TK.Gameplay
{
    ...
    public class NewArmLineRenderer : MonoBehaviour
    {
        ...
        // state
        private ARM_LINE_STATE _state = ARM_LINE_STATE.Growing; // change to hidden later
        ...
        public void ChangeStateToHidden() => State = ARM_LINE_STATE.Hidden;
        ...
        private void Update()
        {
            if (_state == ARM_LINE_STATE.Hidden) return;
        ...
        private void HandleStateChange()
        {
            switch (_state)
            {
                ...
                case ARM_LINE_STATE.Snap:
                    if (!_lineRenderer.enabled) _lineRenderer.enabled = true;
                    SnapToLine(10); // snap the last 10 points to a straight line
                    break;
